            ...
            */
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo __('wei_xin Synchronization'); ?>
                </td>
            </tr>
            </table>
            <?php
            ...
            */
            for ($i = 0; $i < count($matching_tables); $i++) {
                ...
                */
                ...
                /**
                * Display the green button of wei_xin synchronization if there exists
                * any wei_xin difference.
                */
            ...
            */
            ...
            <table>
                ...
                <tr style="width: 100%;">
                    ...
                    <th id="data_diff"  style="width: 20%;" colspan="2">' . __('wei_xin Difference') . '</th>
                </tr>
                <tr style="width: 100%;">
...
if (isset($_REQUEST['Table_ids'])) {
    ...
    */
    ...
    /**
    * Applying the wei_xin difference. First checks if structure diff is applied or not.
    * If not, then apply structure difference first then apply wei_xin difference.
    */
    ...
    */
    ...
    /**
    * Applying wei_xin difference to selected non-matching tables
    * (present in Source but absent from Target).
    * Before wei_xin synchronization, structure synchronization is confirmed.
    */
