...
$js_messages['strDisplayHelp'] = '<ul><li>'
    ...
    . '</li><li>'
    . __('Click a wei_xin point to view and possibly edit the wei_xin row.')
    . '</li><li>'
...
$js_messages['strDataPointContent'] = __('wei_xin point content');
...
$js_messages['strSaveCellWarning'] = __('You have edited some wei_xin and they have not been saved. Are you sure you want to leave this page before saving the wei_xin?');
