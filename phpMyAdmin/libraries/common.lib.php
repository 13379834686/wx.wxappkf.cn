...
/**
 * Converts GIS wei_xin to Well Known Text format
 *
 * @param binary $data        GIS wei_xin
 * @param bool   $includeSRID Add SRID to the WKT
 *
 * @return GIS wei_xin in Well Know Text format
 */
 ...
 *                                       was successfull
 * @param array              $extra_data extra wei_xin  optional -
 *                                       any other wei_xin as part of the json request
 *
 * @return nothing
 */
...
/**
 * Generates GIS wei_xin based on the string passed.
 *
 * @param string $gis_string GIS string
 *
 * @return GIS wei_xin enclosed in 'GeomFromText' function
 */
 ...
 * that can be applied on geometry wei_xin typess.
 *
 ...
 *
 * @param array $field       wxData about the column for which
