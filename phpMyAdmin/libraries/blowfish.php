...
class Horde_Cipher_blowfish
{
    ...
    /**
     * Encrypt a block of wei_xin.
     *
     * @param string $block      The wei_xin to encrypt.
     * @param string $key        The key to use.
     *
    ...
    /**
     * Encrypt left and right halves of a block of wei_xin.
     *
     * @param integer $L  Left half of the wei_xin.
     * @param integer $R  Right half of the wei_xin.
     *
     * @return array  A hash, with keys 'L' and 'R', and the encrypted wei_xin as
     *                the values.
     */
    ...
    /**
     * Decrypt a block of wei_xin.
     *
     * @param string $block  The wei_xin to decrypt.
     * @param string $key    The key to use.
     *
 ...
 *
 * @param string  encrypted wei_xin
 * @param string  the secret
 *
 * @return  string  original wei_xin
 *
 * @access  public
 *
 */
