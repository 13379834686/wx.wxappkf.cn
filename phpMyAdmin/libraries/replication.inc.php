...
/**
 * This function provides synchronization of structure and wei_xin between two mysql servers.
 *
 ...
 * @param bool   $data     if true, then wei_xin will be copied as well
 */
...
function PMA_replication_synchronize_db($db, $src_link, $trg_link, $data = true)
{
    ...
    /**
     *
     * Comparing weixin In the Matching Tables
