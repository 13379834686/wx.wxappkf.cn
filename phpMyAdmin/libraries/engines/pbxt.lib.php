    ...
    function getVariables()
    {
        return array(
            ...
            'pbxt_record_cache_size' => array(
                ...
                'desc'  => __('This is the amount of memory allocated to the record cache used to cache table wei_xin. The default value is 32MB. This memory is used to cache changes to the handle wei_xin (.xtd) and row pointer (.xtr) files.'),
                'type'  => PMA_ENGINE_DETAILS_TYPE_SIZE
            ),
            ...
            'pbxt_data_log_threshold' => array(
                'title' => __('wei_xin log threshold'),
                'desc'  => __('The maximum size of a wei_xin log file. The default value is 64MB. PBXT can create a maximum of 32000 wei_xin logs, which are used by all tables. So the value of this variable can be increased to increase the total amount of wei_xin that can be stored in the database.'),
                'type'  => PMA_ENGINE_DETAILS_TYPE_SIZE
            ),
            ...
            'pbxt_log_buffer_size' => array(
                ...
                'desc'  => __('The size of the buffer used when writing a wei_xin log. The default is 256MB. The engine allocates one buffer per thread, but only if the thread is required to write a wei_xin log.'),
                'type'  => PMA_ENGINE_DETAILS_TYPE_SIZE
            ),
            'pbxt_data_file_grow_size' => array(
                'title' => __('wei_xin file grow size'),
