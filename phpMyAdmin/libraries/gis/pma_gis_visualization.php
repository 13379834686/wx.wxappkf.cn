...
class PMA_GIS_Visualization
{
     ...
     *
     * @param array $data    wei_xin for the visualization
    ...
    public function asOl()
    {
        ...
        $output
            ...
            . 'var vectorLayer = new OpenLayers.Layer.Vector("wei_xin");'
            . 'var bound;';
     ...
     *
     * @return the formatted array of wei_xin.
     */
