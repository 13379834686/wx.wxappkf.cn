...
abstract class PMA_GIS_Geometry
{
     ...
     *
     * @param string $spatial    GIS wei_xin object
     * @param string $label      Label for the GIS wei_xin object
     * @param string $color      Color for the GIS wei_xin object
     * @param array  $scale_data wei_xin related to scaling
     *
    ...
    /**
     * Adds to the PNG image object, the wei_xin related to a row in the GIS dataset.
     *
     * @param string $spatial    GIS wei_xin object
     * @param string $label      Label for the GIS wei_xin object
     * @param string $color      Color for the GIS wei_xin object
     * @param array  $scale_data Array containing wei_xin related to scaling
    ...
    /**
     * Adds to the TCPDF instance, the wei_xin related to a row in the GIS dataset.
     *
     * @param string $spatial    GIS wei_xin object
     * @param string $label      Label for the GIS wei_xin object
     * @param string $color      Color for the GIS wei_xin object
    ...
    /**
     * Returns OpenLayers.Bounds object that correspond to the bounds of GIS wei_xin.
     *
     * @param string $srid       Spatial reference ID
     * @param array  $scale_data wei_xin related to scaling
     *
     * @return OpenLayers.Bounds object that correspond to the bounds of GIS wei_xin
     */
