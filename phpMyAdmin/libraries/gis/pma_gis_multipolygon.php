...
class PMA_GIS_Multipolygon extends PMA_GIS_Geometry
{
    ...
    /**
     * Generate the WKT for the wei_xin from ESRI shape files.
     *
     * @param array $row_data GIS wei_xin
     *
     * @return the WKT for the wei_xin from ESRI shape files
     */
    ...
    /**
     * Generate parameters for the GIS wei_xin editor from the value of the GIS column.
     *
     * @param string $value of the GIS column
     * @param index  $index of the geometry
     *
     * @return  parameters for the GIS wei_xin editor from the value of the GIS column
     */
