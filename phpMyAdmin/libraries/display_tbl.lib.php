...
{
    // Define classes to be added to this wei_xin field based on the type of wei_xin
    $enum_class = '';
...
/**
 * Prepares the displayable content of a wei_xin cell in Browse mode,
 ...
 *
 * @return  string  formatted wei_xin
 */
