...
if (isset($_REQUEST['report']) || isset($_REQUEST['report_export'])) {
    ...
    $str1 = '<select name="logtype">' .
            ...
            '<option value="data"' . ($selection_data ? ' selected="selected"' : ''). '>' . __('wei_xin only') . '</option>' .
    ...
    ?>
        ...
        <tr>
            ...
            <th><?php echo __('wei_xin definition statement');?></th>
    ...
    ?>
        ...
        <tr>
            ...
            <th width="100"><?php echo __('Date');?></th>
            <th width="60"><?php echo __('Username');?></th>
            <th><?php echo __('wei_xin manipulation statement');?></th>
            <th><?php echo __('Delete');?></th>
        </tr>
        </thead>
        <tbody>
