<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"F:\phpstudy\PHPTutorial\WWW\public/../application/admin\view\auth_group\edit.html";i:1527589613;s:67:"F:\phpstudy\PHPTutorial\WWW\application\admin\view\public\meta.html";i:1521453044;s:69:"F:\phpstudy\PHPTutorial\WWW\application\admin\view\public\footer.html";i:1521443164;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="" method="post" class="form form-horizontal" id="form-admin-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $authGroups['title']; ?>" placeholder="" id="title" name="title">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="status" type="radio" id="sex-1" value="1" <?php if($authGroups['status'] == 1): ?> checked <?php endif; ?>>
					<label for="sex-1">启用</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="sex-2" name="status" value="0" <?php if($authGroups['status'] == 0): ?> checked <?php endif; ?>>
				...
				<tr>
					<td>
						<label>
							...
							<input name="rules[]" value="<?php echo $vo['id']; ?>" <?php $arr=explode(',',$authGroups['rules']); if(in_array($vo['id'],$arr)){echo 'checked="checked"';}?>  dataid="id-<?php echo $vo['dataid']; ?>" class="inverted checkbox-parent <?php if($vo['level'] != 0): ?> checkbox-child <br/> <?php endif; ?>" type="checkbox">
